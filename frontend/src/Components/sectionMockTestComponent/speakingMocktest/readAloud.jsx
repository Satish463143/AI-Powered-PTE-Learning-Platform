...
const Question = ({ number, data, prepTime, recordingTime, status }) => (
  <div>
    ...
    <RecordingBox 
      ...
      status={status}
    />
    <p style={{marginTop: '20px'}}>{data || `Sample text for reading aloud question ${number}.`}</p>
  </div>
);

const ReadAloud = ({ onNext, updateProgress }) => {
