...
const Question = ({ data }) => {
    ...
    return (
        <div>
            <h2 className='font-bold'>Read the text and answer the multiple-choice question by selecting the correct response. Only one response is correct.</h2>
...
const HighlightCorrectSummary = ({ onNext, updateProgress }) => {
