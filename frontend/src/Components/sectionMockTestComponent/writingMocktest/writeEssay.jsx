...
const questionsData = [
  {
    question: "Write essay 1: Should parents be held legally responsible for the actions of their children? Support your opinion from your study, observations or experiences."
  },
  {
...
const EssayQuestion = ({ data, questionData }) => {
  ...
  return (
    <div className='mock_writing_container'>
      ...
      <p style={{margin:'20px 0'}}>{data ? data.question : questionData.question}</p>
      <textarea 
        ref={textareaRef}
        rows='15' 
        name="Summarize text" 
...
const WriteEssay = ({ onNext, updateProgress }) => {
