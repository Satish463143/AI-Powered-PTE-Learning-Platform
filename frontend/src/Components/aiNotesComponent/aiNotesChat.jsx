...
const AiNotesChat = ({handleMenuBar}) => {
    ...
    <div>
        <div className={`progressChat ${handleMenuBar ? 'progress_bar_active' : ''}`}>
            <div className="container">
                ...
                <h2 style={{marginTop: '20px', fontSize: '20px', fontWeight: '500'}}>Ai Chat Window(थप प्रश्न सोध्नुहोस्)</h2> 
                <div className="chat_box">
                    ...
                    <div className="chat_input chat_div_input" style={{bottom:'10px'}}>
                        ...
                        className="w-full max-w-100% h-10 px-4 py-2 border-2 border-black rounded-lg text-base sm:text-sm"
                        value={inputValue}
