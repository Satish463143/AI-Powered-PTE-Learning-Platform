...
const Q1 = ({data, audioRef, audioPlaying, prepTime, onAudioLoad}) =>{
  ...
  return(
    <div>
      <h2>
        You will hear a sentence. Write the summary of the audio.
      </h2>
...
const Listening_1 = ({ onNext, updateProgress }) => {
  ...
  useEffect(() => {
    if (audioRef.current) {
      ...
      const handleError = (e) => {
        ...
        Swal.fire({
          title: "Audio Error",
          text: "There was an error loading the audio. Please try again.",
          icon: 'error',
