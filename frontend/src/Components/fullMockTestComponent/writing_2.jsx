...
const dummyData = {
  "question" : " Writing 2 :Many people who have written on the subject of allowances say it is not a good idea to pay your child for work around the home. These jobs are a normal part of family life. Paying children to do extra work around the house, however, can be useful. It can even provide an understanding of how a business works."
}
...
const Writing_2 = ({ onNext, updateProgress, questions, onQuestionsGenerated }) => {
